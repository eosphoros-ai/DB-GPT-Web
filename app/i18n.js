...
const resources = {
  en: {
    translation: {
      ...
      Copy: 'Copy',
      Copy_to_clipboard: 'The content has been copied to the clipboard',
      Copy_nothing: 'There is no content to copy',
  ...
  zh: {
    translation: {
      ...
      input_unit: '字',
      Copy: '复制',
      Copy_to_clipboard: '内容已复制到剪贴板',
      Copy_nothing: '没有内容可以复制',
      Click_Select: '点击选择',
    },
  },
};
